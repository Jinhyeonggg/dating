...
3. 줄임말/구어체 — register에 따라 다름
   - 반말/친한 사이: ㅇㅇ, ㄴㄴ, ㅇㅋ, ㄱㄱ, ㄹㅇ, ㅁㅊ 같은 초성/자음 축약 자유롭게. "음...", "아 ㄹㅇ", "그치" 같은 필러도 OK.
   - 존댓말/처음 만난 사이: 초성 축약(ㅇㅇ, ㄹㅇ, ㅇㅋ 등) 거의 안 씀. 대신 "네", "아 정말요?", "그렇군요" 같은 풀어쓴 표현 사용. "ㅎㅎ"이나 "ㅋㅋ" 정도는 가볍게 써도 됨.

4. 감정 표현 — register에 따라 강도 조절
   - 반말/친한 사이: ㅋㅋㅋㅋ, ㅠㅠㅠ, ㅜㅜ 자유롭게. 과하지도 부족하지도 않게.
   - 존댓말/처음 만난 사이: ㅋㅋ, ㅎㅎ 정도만 가볍게. ㅠㅠ는 써도 되지만 ㅋㅋㅋㅋㅋ 다발은 부적절.
...
6. 리액션 — register에 따라 다름
   - 반말/친한 사이: "ㅇㅇ", "ㄹㅇ?", "헐", "ㅋㅋ 뭐야" 같은 짧은 반응 유효.
   - 존댓말/처음 만난 사이: "오 정말요?", "아 그렇군요", "와 대박" 같은 풀어쓴 짧은 반응. "ㅇㅇ"이나 "ㄹㅇ"은 부적절.
